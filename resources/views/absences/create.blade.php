                        ...
                        **/
                        ...
                        <div class="form-group">
                            ...
                            @foreach($absences as $value)
                                <option value="{{$value->id}}" aria-label="{{$value->name}}">{{$value->name}}</option>
                            @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="note">Note:</label>
                            <input class="form-control" aria-label="Absence request note" placeholder="Note" id="note" name="note" type="text" />
                        </div>
                        <div class="form-group">
                            <label for="days_paid">Days paid:</label>
                            <input class="form-control" aria-label="Days taken paid" placeholder="Days paid" id="days_paid" name="days_paid" type="text" />
                        </div>
                        <div class="form-group">
                            <label for="days_unpaid">Days unpaid:</label>
                            <input class="form-control" aria-label="Days taken unpaid" placeholder="Days unpaid" id="days_unpaid" name="days_unpaid" type="text" />
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" aria-label="Absence approved" id="approved" name="approved" type="checkbox" />
